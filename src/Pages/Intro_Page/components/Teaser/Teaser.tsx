...
const TEASER_INFO = "Our stock is large, it will take some time. Besides, admin (shame on him) set 1s interval between requests. That is why it takes that long ";
